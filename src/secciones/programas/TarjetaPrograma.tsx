...
export function TarjetaPrograma({
  ...
  return (
    <Reveal delay={delay}>
      <article className="flex h-full flex-col overflow-hidden rounded-3xl border border-border/70 bg-white shadow-sm transition-shadow hover:shadow-lg">
        <motion.div
        ...
        <div className="flex flex-1 flex-col gap-4 p-6">
          <div>
            <h3 className="text-xl font-bold text-iex-navy">
              {t(`${base}.title`)}
            </h3>
