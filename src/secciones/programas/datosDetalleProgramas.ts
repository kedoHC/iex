...
export const detalleProgramas: Record<IdPrograma, ConfigDetallePrograma> = {
  ...
  /** Fotos revisadas contra images.unsplash.com (varias URLs anteriores devolvían 404). */
  epic: {
    hero: u("photo-1531482615713-2afd69097998", 1920),
    bloques: [
      {
        id: "arIngles",
        imagen: u("photo-1509062522246-3755977927d7", 1400),
      },
      {
        id: "robotica",
      ...
      {
        id: "programacion",
        imagen: u("photo-1555949963-ff9fe0c870eb", 1400),
      },
    ],
    carruselInfinito: [
      ...
      u("photo-1522202176988-66273c2fd55f", 900),
      u("photo-1546519638-68e109498ffc", 900),
      u("photo-1529390079861-591de354faf5", 900),
      u("photo-1513475382585-d06e58bcb0e0", 900),
